...
namespace AudioVideoPlayer.Controls.CustomTitleBar
{
    public sealed partial class CustomTitleBar : UserControl, INotifyPropertyChanged
    {
        ...
        Windows.UI.Color backgroundColor = Windows.UI.Colors.DeepSkyBlue;
        ...
        Windows.UI.Color foregroundColor = Windows.UI.Colors.White;
...
//                return 32;
        ...
        public void EnableControlsInTitleBar(bool enable)
        {
            if (enable)
            {
                Window.Current.SetTitleBar(TitleBarContent);
            }
            else
            {
