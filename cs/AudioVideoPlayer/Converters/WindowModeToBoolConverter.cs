...
namespace AudioVideoPlayer.Converters
{
    ...
    /// </summary>
    public class WindowModeToBoolConverter : IValueConverter
    {
        /// <summary>
        ...
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            int windowMode, windowModeParameter;
            if (parameter != null)
            {
                windowMode = System.Convert.ToInt32(value);
                windowModeParameter = System.Convert.ToInt32(parameter);
        ...
        public object ConvertBack(object value, Type targetType, object parameter, string language)
        {
            ...
            int windowModeParameter;
            bool windowsMode;
            if (parameter != null)
            {
                windowsMode = System.Convert.ToBoolean(value);
                windowModeParameter = System.Convert.ToInt32(parameter);

                if (windowsMode == true)
                    return windowModeParameter;
            }
            return null;
        }
    }
